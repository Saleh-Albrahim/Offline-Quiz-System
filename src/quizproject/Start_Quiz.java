...
public class Start_Quiz extends javax.swing.JFrame {
    ...
    public Start_Quiz() {
        initComponents();
        ArrayList<String> quizes = MainView_Student.databaseManager.getQuizNames();
        for (int i = 0; i < quizes.size(); i++) {
            jComboBox1.addItem(quizes.get(i));
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tutorial/view/images/organize.png"))); // NOI18N
        ...
        jLabel1.setText("Choose The Quiz Name :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new do_Quiz(jComboBox1.getSelectedItem().toString()).setVisible(true);
